...
class CatFactsRequestHandler:
    ...
    def __init__(self, cat_facts_service: CatFactsService, cat_facts_model: CatFacts) -> None:
    ...
    def get_cat_facts(self, facts_param, page, showing_range):
        '''...'''

        try:
            self.cat_facts_service.cat_facts_uow.cat_facts_model.facts = facts_param

            list_of_cat_facts = self.cat_facts_service.get_cat_facts()
